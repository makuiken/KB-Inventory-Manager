...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-5ws&l#@40b98aa-es5w2(*!uuow1e0ot3tr2)u$7=s*f)$1u+)')
...
CSRF_TRUSTED_ORIGINS = ['https://web-production-eece.up.railway.app']
